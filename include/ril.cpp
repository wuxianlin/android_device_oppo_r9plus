...
*/
    switch(request) {
		...
		case UNSOL_RAU_CHANGED: return "UNSOL_RAU_CHANGED";
		case RIL_UNSOL_OEM_LTE_CPHY_CA: return "RIL_UNSOL_OEM_LTE_CPHY_CA";
		case UNSOL_OEM_KEY_LOG_ERROR_MSG: return "UNSOL_OEM_KEY_LOG_ERROR_MSG";
