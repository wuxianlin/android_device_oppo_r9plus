...
*/
    ...
    {UNSOL_RAU_CHANGED, responseString, WAKE_PARTIAL},
    {RIL_UNSOL_OEM_LTE_CPHY_CA, responseString, WAKE_PARTIAL},
    {UNSOL_OEM_KEY_LOG_ERROR_MSG, responseString, WAKE_PARTIAL},
